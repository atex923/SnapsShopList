...
enum AppErrorLogger {
    ...
    static var fileURL: URL {
        folderURL.appendingPathComponent("SnapshotBuyCheck-runtime.log")
    }
    ...
    private static func writeLogFile(_ entries: [AppErrorEntry]) throws {
        ...
        let header = "SnapshotBuyCheck \(AppTheme.version) runtime error log\n"
    ...
    var body: some View {
        ...
        .toolbar {
            ToolbarItemGroup(placement: .topBarTrailing) {
                ShareLink(item: AppErrorLogger.fileURL) {
